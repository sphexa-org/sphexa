                  ...
                  cudaStream_t stream)
{
    ...
    findHalosKernel<<<numBlocks, numThreads, 0, stream>>>(prefixes, childOffsets, parents, nodeCenters, nodeSizes,
                 ...
                 cudaStream_t stream)
{
    ...
    if (numFocusNodes)
    {
        markMacsGpuKernel<<<numBlocks, numThreads, 0, stream>>>(prefixes, childOffsets, parents, centers, box,
