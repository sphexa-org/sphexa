...
template void gatherGpu(const unsigned long*, size_t, const uint8_t*, uint8_t*);
...
template void gatherGpu(const unsigned long*, size_t, const char*, char*);
template void gatherGpu(const unsigned long*, size_t, const int*, int*);
template void gatherGpu(const unsigned long*, size_t, const long*, long*);
...
template void gatherGpu(const unsigned long*, size_t, const util::array<float, 1>*, util::array<float, 1>*);
template void gatherGpu(const unsigned long*, size_t, const util::array<float, 2>*, util::array<float, 2>*);
template void gatherGpu(const unsigned long*, size_t, const util::array<float, 3>*, util::array<float, 3>*);
template void gatherGpu(const unsigned long*, size_t, const util::array<float, 4>*, util::array<float, 4>*);
