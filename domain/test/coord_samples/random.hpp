...
public:
    ...
    void shuffle()
    {
        ...
        gatherArrays(permutation, 0, std::tie(x_, y_, z_, h_, codes_), std::tie(s1, s2), execution::cpu);
        isSfcOrdered_ = false;
    }
...
protected:
    void sfcSort()
    {
        ...
        gatherArrays(sfcOrder, 0, std::tie(x_, y_, z_, h_), std::tie(temp), execution::cpu);
        isSfcOrdered_ = true;
    }
