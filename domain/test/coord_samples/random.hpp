...
public:
    ...
    void shuffle()
    {
        ...
        gatherArrays(permutation, 0, std::tie(x_, y_, z_, h_, codes_), std::tie(s1, s2), Stream<CpuTag>{});
        isSfcOrdered_ = false;
    }
...
protected:
    void sfcSort()
    {
        ...
        gatherArrays(sfcOrder, 0, std::tie(x_, y_, z_, h_), std::tie(temp), Stream<CpuTag>{});
        isSfcOrdered_ = true;
    }
