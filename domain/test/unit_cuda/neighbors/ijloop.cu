...
using Neighborhoods = ::testing::Types<
    ...
    ijloop::GpuSuperclusterNbListNeighborhood<>::withClusterSize<4, 4>::withoutSymmetry::withoutCompression,
    ijloop::GpuSuperclusterNbListNeighborhood<>::withClusterSize<4, 4>::withSymmetry::withoutCompression,
    ijloop::GpuSuperclusterNbListNeighborhood<>::withClusterSize<4, 4>::withoutSymmetry::withCompression,
    ijloop::GpuSuperclusterNbListNeighborhood<>::withClusterSize<4, 4>::withSymmetry::withCompression,
