...
function(cstone_add_performance_test sourcename testname)
    ...
    if (${ARGC} GREATER 2)
        set_tests_properties(${testname} PROPERTIES LABELS "${ARGV2}")
    endif ()
endfunction()
...
function(cstone_add_cuda_performance_test sourcename testname)
    ...
    target_link_libraries(${testname} PRIVATE cstone_gpu ${CSTONE_THRUST_LIBS} OpenMP::OpenMP_CXX)
    target_compile_options(${testname} PRIVATE $<$<COMPILE_LANGUAGE:CUDA>:-Xcompiler=${OpenMP_CXX_FLAGS}>)
    add_test(NAME ${testname} COMMAND ${testname})
    install(TARGETS ${testname} RUNTIME DESTINATION ${CMAKE_INSTALL_SBINDIR}/performance)
    if (${ARGC} GREATER 2)
        set_tests_properties(${testname} PROPERTIES LABELS "${ARGV2}")
